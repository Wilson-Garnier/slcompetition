          ...
          <div class="row">
            ...
            <div class="col-lg-8 col-md-8">
              <p class="cart_no infotext">
                ...
                <a href="<?php if(function_exists('wc_get_cart_url')){ echo esc_url(wc_get_cart_url()); } ?>" title="<?php esc_html_e( 'shopping cart','automobile-hub' ); ?>"><?php esc_html_e('Panier','automobile-hub'); ?></a>
              </p>
